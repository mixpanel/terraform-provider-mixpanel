...
func TestAccOrgRequestAccessSettings_lifecycle(t *testing.T) {
...
resource "mixpanel_org_request_access_settings" "test" {

}`),
			},
			{
				// Import the resource and assert state round-trips through Read.
				ResourceName:                         "mixpanel_org_request_access_settings.test",
				ImportState:                          true,
				ImportStateVerify:                    true,
				ImportStateVerifyIdentifierAttribute: "id",
				ImportStateIdFunc:                    importIDFunc("mixpanel_org_request_access_settings.test", "id", ""),
