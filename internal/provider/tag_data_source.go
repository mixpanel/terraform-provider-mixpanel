...
import (
	...
	dsc "github.com/mixpanel/terraform-provider-mixpanel/internal/provider/datasource_tag"
)
...
// NewTagDataSource constructs the tag data source.
...
func (d *TagDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Decoding tag response", err.Error())
		return
	}
	...
	if err != nil {
		resp.Diagnostics.AddError("Building tag state", err.Error())
		return
	}
	resp.State.Raw = val
	_ = tftypes.Value{}
