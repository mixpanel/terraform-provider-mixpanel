...
func (r *WorkspaceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	r.writeWorkspaceState(ctx, &resp.State, &resp.Diagnostics, req.Plan.Raw, wire, projectID, id)
}
...
func (r *WorkspaceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	r.writeWorkspaceState(ctx, &resp.State, &resp.Diagnostics, req.State.Raw, wire, projectID, id)
}
...
func (r *WorkspaceResource) writeWorkspaceState(ctx context.Context, state *tfsdk.State, diags *diagAppender, base tftypes.Value, wire map[string]any, projectID, id string) {
