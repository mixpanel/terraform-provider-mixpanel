...
func TestAccTwofactorSettings_lifecycle(t *testing.T) {
...
resource "mixpanel_twofactor_settings" "test" {

}`),
			},
			{
				// Import the resource and assert state round-trips through Read.
				ResourceName:                         "mixpanel_twofactor_settings.test",
				ImportState:                          true,
				ImportStateVerify:                    true,
				ImportStateVerifyIdentifierAttribute: "id",
				ImportStateIdFunc:                    importIDFunc("mixpanel_twofactor_settings.test", "id", ""),
