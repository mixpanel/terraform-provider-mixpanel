...
func TestAccHeatMap_lifecycle(t *testing.T) {
...
resource "mixpanel_heat_map" "test" {
  title = "tf-acc-test"
  url = "tf-acc-test"
}`),
			},
			{
				...
				Config: providerConfig(srv.URL, `
resource "mixpanel_heat_map" "test" {
  title = "tf-acc-renamed"
  url = "tf-acc-test"
}`),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("mixpanel_heat_map.test", plancheck.ResourceActionUpdate),
					},
				},
			},
		},
