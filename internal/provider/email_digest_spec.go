...
func EmailDigestAttrSpec() client.AttrSpec {
	return client.AttrSpec{
		...
		CreateWritableAttrs: map[string]bool{"dashboard_id": true, "deleted": true, "monthly_week_ordinal": true, "name": true, "paused": true, "recipients": true, "recur": true, "schedule_timezone": true, "slack_subscriptions": true, "start_date": true, "tag": true, "timezone": true},
		UpdateWritableAttrs: map[string]bool{"dashboard_id": true, "deleted": true, "monthly_week_ordinal": true, "name": true, "paused": true, "recipients": true, "recur": true, "slack_subscriptions": true, "start_date": true, "tag": true, "timezone": true},
	}
}
