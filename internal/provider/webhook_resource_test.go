...
func TestAccWebhook_lifecycle(t *testing.T) {
...
resource "mixpanel_webhook" "test" {
  name = "tf-acc-test"
  url = "tf-acc-test"
}`),
			},
  ...
  url = "tf-acc-test"
				...
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("mixpanel_webhook.test", plancheck.ResourceActionUpdate),
					},
				},
			},
			{
