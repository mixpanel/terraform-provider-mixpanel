...
func TestAccSparkSettings_lifecycle(t *testing.T) {
...
resource "mixpanel_spark_settings" "test" {

}`),
			},
			{
				// Import the resource and assert state round-trips through Read.
				ResourceName:                         "mixpanel_spark_settings.test",
				ImportState:                          true,
				ImportStateVerify:                    true,
				ImportStateVerifyIdentifierAttribute: "id",
				ImportStateIdFunc:                    importIDFunc("mixpanel_spark_settings.test", "id", ""),
